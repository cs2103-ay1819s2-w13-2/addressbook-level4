...
public class HelpCommandSystemTest extends AddressBookSystemTest {
    ...
    public void openHelpWindow() {
        ...
        executeCommand(MemberSelectCommand.COMMAND_WORD + " " + INDEX_FIRST_PERSON.getOneBased());
        ...
        executeCommand(MemberDeleteCommand.COMMAND_WORD + " " + INDEX_FIRST_PERSON.getOneBased());
