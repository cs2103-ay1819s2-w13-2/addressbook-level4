...
public class MemberDeleteCommandTest {
    ...
    public void execute_validIndexUnfilteredList_success() {
        ...
        MemberDeleteCommand MemberDeleteCommand = new MemberDeleteCommand(INDEX_FIRST_PERSON);

        String expectedMessage = String.format(MemberDeleteCommand.MESSAGE_DELETE_PERSON_SUCCESS, personToDelete);

        ModelManager expectedModel = new ModelManager(model.getAddressBook(), new UserPrefs());
        expectedModel.deletePerson(personToDelete);
        expectedModel.commitAddressBook();

        assertCommandSuccess(MemberDeleteCommand, model, commandHistory, expectedMessage, expectedModel);
    }
    ...
    public void executeUndoRedo_validIndexUnfilteredList_success() throws Exception {
        ...
        MemberDeleteCommand.execute(model, commandHistory);
    ...
    @Test
    public void equals() {
        MemberDeleteCommand deleteFirstCommand = new MemberDeleteCommand(INDEX_FIRST_PERSON);
        MemberDeleteCommand deleteSecondCommand = new MemberDeleteCommand(INDEX_SECOND_PERSON);

        // same object -> returns true
        assertTrue(deleteFirstCommand.equals(deleteFirstCommand));

        // same values -> returns true
        MemberDeleteCommand deleteFirstCommandCopy = new MemberDeleteCommand(INDEX_FIRST_PERSON);
