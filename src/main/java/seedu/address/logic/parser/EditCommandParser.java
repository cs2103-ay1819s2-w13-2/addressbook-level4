...
public class EditCommandParser implements Parser<MemberEditCommand> {
     ...
     * and returns an MemberEditCommand object for execution.
     * @throws ParseException if the user input does not conform the expected format
     */
    public MemberEditCommand parse(String args) throws ParseException {
        requireNonNull(args);
        ...
        if (!editPersonDescriptor.isAnyFieldEdited()) {
            throw new ParseException(MemberEditCommand.MESSAGE_NOT_EDITED);
        }

        return new MemberEditCommand(index, editPersonDescriptor);
    }
